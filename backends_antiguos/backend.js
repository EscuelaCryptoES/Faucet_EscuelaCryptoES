...
app.get('/sendtx',function(req,res){
        ...
        web3js.eth.getTransactionCount(myAddress).then(function(v){
            ...
            var rawTransaction = {"from":myAddress, "gasPrice":web3js.utils.toHex(20* 1e9),"gasLimit":web3js.utils.toHex(210000),"to":contractAddress,"value":"0x0","data":contract.methods.refundUser(telegramUser, toAddress).encodeABI(),"nonce":web3js.utils.toHex(count)}
